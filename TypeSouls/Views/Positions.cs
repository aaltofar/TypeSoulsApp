...
public static class Position
{
    ...
    public static (int, int) RightMid = (Console.WindowWidth / 4 * 3, Console.WindowHeight / 2);
    public static (int, int) RightTop = (Console.WindowWidth / 4 * 3, Console.WindowHeight / 8);
    public static (int, int) RightBot = (Console.WindowWidth / 4 * 3, Console.WindowHeight / 4 * 3);
}
